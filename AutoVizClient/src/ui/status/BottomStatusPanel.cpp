...
{
    const auto* location = findTopicStatus(snapshot.topicStatuses, QStringLiteral("vehicle_state"));
    const auto* control = findTopicStatus(snapshot.topicStatuses, QStringLiteral("control_command"));
    const auto* chassis = findTopicStatus(snapshot.topicStatuses, QStringLiteral("chassis_state"));
    const auto* action = findTopicStatus(snapshot.topicStatuses, QStringLiteral("action_state"));
...
QString overallStateText(const autoviz::datacenter::VisualizationSnapshot& snapshot)
{
    ...
    const auto* command = findTopicStatus(snapshot.topicStatuses, QStringLiteral("control_command"));
    ...
    const auto* finalObjects = findTopicStatus(snapshot.topicStatuses, QStringLiteral("obstacles"));
...
void BottomStatusPanel::updateOverview(const autoviz::datacenter::VisualizationSnapshot& snapshot)
{
    ...
    const auto* locationTopic = findTopicStatus(snapshot.topicStatuses, QStringLiteral("vehicle_state"));
    const auto* controlTopic = findTopicStatus(snapshot.topicStatuses, QStringLiteral("control_command"));
    const auto* chassisTopic = findTopicStatus(snapshot.topicStatuses, QStringLiteral("chassis_state"));
    const auto* obstacleTopic = findTopicStatus(snapshot.topicStatuses, QStringLiteral("obstacles"));
