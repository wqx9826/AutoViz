...
void RosbagPlaybackDialog::chooseBag(){const QString dir=QFileDialog::getExistingDirectory(this,tr("选择 ROS2 bag 目录"),m_path->text());if(dir.isEmpty())return;emit playbackLoading();m_path->setText(dir);m_channels->clear();m_progress->setValue(0);m_source->loadAndValidate(dir);}
