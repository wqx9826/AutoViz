...
TEST(RobotWsProtoConverterTest, PreservesChassisYawAndUsesTypedDiagnostics)
{
    ...
    source.right_tail_motor_bus_current = 4.6;
    source.right_tail_motor_controller_temperature = 32;
    source.right_tail_motor_target_speed_rpm = 121.0;
    source.right_tail_motor_actual_speed_rpm = 119.0;
    source.left_vertical_motor_bus_current = 5.1;
    source.left_vertical_motor_controller_temperature = 33;
    source.left_vertical_motor_target_speed_rpm = 122.0;
    source.left_vertical_motor_actual_speed_rpm = 120.0;
    source.right_vertical_motor_bus_current = 5.2;
    source.right_vertical_motor_controller_temperature = 34;
    source.right_vertical_motor_target_speed_rpm = 123.0;
    source.right_vertical_motor_actual_speed_rpm = 121.0;
    source.back_vertical_motor_bus_current = 5.3;
    source.back_vertical_motor_controller_temperature = 35;
    source.back_vertical_motor_target_speed_rpm = 124.0;
    source.back_vertical_motor_actual_speed_rpm = 122.0;
    ...
    EXPECT_EQ(actual.tail_thruster_motor(0).id(), "left_tail_thruster");
    EXPECT_DOUBLE_EQ(actual.tail_thruster_motor(0).actual_speed_rpm(), 118.0);
    ASSERT_EQ(actual.thruster_motor_size(), 5);
    EXPECT_EQ(actual.thruster_motor(0).id(), "left_tail_thruster");
    EXPECT_DOUBLE_EQ(actual.thruster_motor(0).bus_current_a(), 4.5);
    EXPECT_EQ(actual.thruster_motor(1).id(), "right_tail_thruster");
    EXPECT_EQ(actual.thruster_motor(2).id(), "left_vertical_thruster");
    EXPECT_EQ(actual.thruster_motor(2).controller_temperature_c(), 33);
    EXPECT_DOUBLE_EQ(actual.thruster_motor(2).target_speed_rpm(), 122.0);
    EXPECT_EQ(actual.thruster_motor(3).id(), "right_vertical_thruster");
    EXPECT_DOUBLE_EQ(actual.thruster_motor(3).actual_speed_rpm(), 121.0);
    EXPECT_EQ(actual.thruster_motor(4).id(), "back_vertical_thruster");
    EXPECT_DOUBLE_EQ(actual.thruster_motor(4).bus_current_a(), 5.3);
